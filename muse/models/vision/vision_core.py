...
from muse.utils.torch_utils import combine_dims, sample_random_image_crops, split_dim
...
class VisionCore(torch.nn.Module):
    ...
    def __init__(self, name, in_channels=3, flip=True, flatten=True, cut_last=0, raw_out_size=1000,
                 out_size=None, randomizers=None, extra_conv_layers=[], **kwargs):
        ...
        if out_size is not None:
            layers.append(torch.nn.Linear(raw_out_size, out_size))
