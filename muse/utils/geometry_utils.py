...
import muse.utils.transform_utils
import muse.utils.transform_utils as T
from muse.envs.bullet_envs.control_utils import batch_orientation_error
...
if __name__ == '__main__':
    ...
    # RPT -> QUAT
    q = np_rpt_to_quat(muse.utils.transform_utils.convert_eul_to_rpt(eul1))
