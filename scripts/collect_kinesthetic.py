...
if __name__ == '__main__':
    ...
    while not terminate_fn(step, ep):
        ...
        obs, goal = env.reset()
        policy_kinesthetic.reset_policy(next_obs=obs, next_goal=goal)

        kin_obs_history, kin_goal_history, kin_ac_history = rollout(args, policy_kinesthetic, env, model, obs, goal)
