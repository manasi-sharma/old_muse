...
export = d(
    ...
    horizon=10,
    seed=0,
    dataset='lift_diverse_500ep_eimgs',
    exp_name='affordance/velact_{?seed:s{seed}_}b{batch_size}_h{horizon}_{dataset}',
    # utils=utils,
    env_spec=block3d.export.cls.get_default_env_spec_params(block3d.export),
    ...
    dataset_train=np_seq.export & d(
        ...
        batch_names_to_get=['policy_type', 'ee_position', 'ee_orientation', 'objects/position', 'objects/orientation',
                            'gripper_pos', 'policy_switch', 'action'],
    ),
